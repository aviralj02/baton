...
export function GitHubLink() {
  return (
    <motion.a
      ...
      whileFocus="hover"
      whileTap={{ scale: 0.96 }}
      className="group inline-flex items-center rounded-full border border-black/10 p-2 text-stone-500 transition-colors duration-200 hover:border-brand/40 hover:text-brand dark:border-white/10 dark:text-stone-400"
    >
      <motion.span
